...
if f: #output
    ...
    DigitalOut(name='trg_osc', parent_device=DO0, connection=str(0))
    DigitalOut(name='MOT_2D_trg', parent_device=DO0, connection=str(1))
    DigitalOut(name='MOT_3D_trg', parent_device=DO0, connection=str(2))
    DigitalOut(name='Imaging_trg', parent_device=DO0, connection=str(3))
    for i in range(4,15):
        DigitalOut(name='digimon'+str(i+1), parent_device=DO0, connection=str(i))   
    DigitalOut(name='Andor_trg', parent_device=DO0, connection=str(15))  
    ...
    AnalogOut     (name='COILS', parent_device=AO0, connection='0x08')
    AnalogOut     (name='ANDOR', parent_device=AO0, connection='0x09')
...
if m:
    ...
    # MOG_QRF(name='QFR_0', parent_device=CL, addr='192.168.1.103', port=7802)
