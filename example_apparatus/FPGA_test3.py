...
if False:
    ...
    samples = int(2.5e5)
    t_start = t
    t = generate_analog_samples(AnalogOut_device=Freezer, start_time=t, time_step=dt, end_time=None, num_samples=samples, Umin=-10, Umax=+10, dU=1)
    if secondary:
        t = generate_analog_samples(AnalogOut_device=Goku, start_time=t_start, time_step=dt, end_time=None, num_samples=samples, Umin=-10, Umax=+10, dU=1)
    t += dt
