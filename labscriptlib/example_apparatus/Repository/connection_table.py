...
if f:
    ...
    primary   = FPGA_board(name='board0',  ip_address='192.168.1.10', ip_port=DEFAULT_PORT, bus_rate=1.0, num_racks=1,
                       ...
                       worker_args={'inputs': {'NOP bit' : ('data bits 28-31', 'offset bit 3'),
                                               ...
                                               'start trigger'  : ('input 0', 'high level')},
...
if m:
    ...
    DigitalChannels(name='DO_QRF1', parent_device=board0, connection='0x07', rack=0, max_channels=16)
    DigitalOut(name='QRF_trigger_1', parent_device=DO_QRF1, connection=15)
