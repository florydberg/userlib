...
for i in range(0,GLOBALS['n_loop']):
    ...
    t-=GLOBALS['MOT_RED_duration']/2   ########### TIME MACHINE  ############################ 600*msec for BlueMot
    ...
    t+=GLOBALS['MOT_RED_duration']/2 ############### TIME MACHINE  ############################
    ...
    # fluo_detuned_Blue(t- GLOBALS['advanceTime'])

    # Twizzi_Switch_TTL(t- GLOBALS['Tweezer_duration'], True)
