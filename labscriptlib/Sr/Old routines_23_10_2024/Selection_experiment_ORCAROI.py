...
if co:
    ...
    if GLOBALS['Orca_ROI']=='full':
        Orca_Camera.camera_attributes['SUBARRAY WIDTH']=4096.0
        Orca_Camera.camera_attributes['SUBARRAY HEIGHT']=2304.0
        ...
        Orca_Camera.camera_attributes['SUBARRAY WIDTH']=100
        Orca_Camera.camera_attributes['SUBARRAY HEIGHT']=100
        Orca_Camera.camera_attributes['SUBARRAY HPOS']=2360
        Orca_Camera.camera_attributes['SUBARRAY VPOS']=841
