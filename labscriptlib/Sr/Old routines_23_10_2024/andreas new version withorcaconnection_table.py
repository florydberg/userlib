...
mr=1 #MogLabsRed
ca=0 #Camera Andor
cb_abs=0 #Camera Basler for Absorption
...
if cb_abs:
    ...
    Basler_Camera_abs = PylonCamera('Basler_Camera_abs',parent_device=DO0, parentless=False, connection=8,
            ...
            trigger_duration=10,
            stop_acquisition_timeout=100000,
            exception_on_failed_shot=False,
            camera_attributes = {
                'ExposureMode': 'Timed',
...
if co:
    ...
    Orca_Camera= DCAMCamera('Orca_Camera', parent_device=DO0, 
                            connection=7,
                            ...
                            camera_attributes = {
                                ...
                                'TIMING READOUT TIME': 0.0001 , #0.0564984,
                                'TIMING CYCLIC TRIGGER PERIOD': 0.0,
                                'TIMING MIN TRIGGER BLANKING': 0.0,
                                'TIMING MIN TRIGGER INTERVAL': 0.0564984,
                                'TIMING GLOBAL EXPOSURE DELAY': 2.88e-05,
                                'TIMING EXPOSURE': 3.0,
                                'TIMING INVALID EXPOSURE PERIOD': 2.88e-05,

                                'INTERNAL FRAME RATE': 17.69961627231922,
                                'INTERNAL FRAME INTERVAL': 0.0564984,
                                'INTERNAL LINE SPEED': 0.638888888888889,
                                'INTERNAL LINE INTERVAL': 7.2e-06,

                                'FRAMEBUNDLE MODE': 1.0,
                                'FRAMEBUNDLE NUMBER': 2.0,
                                'FRAMEBUNDLE ROWBYTES': 8192.0,
                                'FRAMEBUNDLE FRAME STEP BYTES': 18874368.0,
                                ...
                                'BUFFER ROWBYTES': 8192.0,
                                'BUFFER FRAMEBYTES': 18874368.0,
                                ...
                                'IMAGE DETECTOR PIXEL WIDTH': 4.6000000000000005,
                                'IMAGE DETECTOR PIXEL HEIGHT': 4.6000000000000005,
                                'IMAGE DETECTOR PIXEL NUM HORZ': 4096.0,
                                'IMAGE DETECTOR PIXEL NUM VERT': 2304.0,
