...
for i in range(0,GLOBALS['n_loop']):
    ...
    if sel_mot_red:
        ...
        if sel_tweezer:
            ...
            if GLOBALS['LAC']: 
                ...
                t+=5*dt
                # NEW_TABLE_LINE('ImagingBeam', t, GLOBALS['ImagingFluo_Frq']/1e6, GLOBALS['blue_LAC_Pow'])
                t+=3*dt
                t+=GLOBALS['LAC_duration']
        ...
        if sel_imaging_beam=="abs":
            if sel_tweezer:
                ...
                while tt-t < GLOBALS['FluoImaging_duration']:
                    ...
                    NEW_TABLE_LINE('ImagingBeam', tt, GLOBALS['ImagingFluo_Frq']/1e6, GLOBALS['ImagingFluo_Pow'])
                    tt+=delta_imaging
                    TABLE_MODE_OFF('ImagingBeam', tt)
    ...
    if GLOBALS['second_shot']:
        NEW_TABLE_LINE('ImagingBeam', t, GLOBALS['ImagingFluo_Frq']/1e6, GLOBALS['ImagingFluo_Pow'])
        ...
        # Sisyphus_AOM_TTL(t,False)
        t+=dt
        NEW_TABLE_LINE('Sisyphus', t, (GLOBALS['Red_MOT_Frq']+0.5*GLOBALS['Sisyphus2ndImg_Frq'])/1e6, GLOBALS['SisyphusImg_Pow'])
        tt=t
        Sisyphus_AOM_TTL(t,True)
        TABLE_MODE_OFF('Sisyphus', t + GLOBALS['FluoImaging_duration'])
        Sisyphus_AOM_TTL(t+GLOBALS['FluoImaging_duration'],False)
