...
def import_GLOBALS(settings_path): #init of globals and times
    ...
    GLOBALS={}
    for i in runmanager.remote.get_globals(): #get_shot_globals(settings_path): #
        print(str(i))
        GLOBALS[str(i)]=eval(i)*units[str(i)]
    return GLOBALS

settings_path='C:\\Experiments\\Test_AWG_Spectrum\\test.h5'
GLOBALS=import_GLOBALS(settings_path) # import GLOBALS from the shot file
