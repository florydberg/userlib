        ...
        if sel_mot_red_sf:
            ...
            if False:
                ...
                for i in range(n_steps):
                    NEW_TABLE_LINE('RedMOT', t-5*usec, (frq_i + (frq_f-frq_i)*i/n_steps)/1e6, GLOBALS['Red_MOT_Pow']+(n_steps-i)/n_steps*GLOBALS['Red_MOT_Pow']*0.15)
                    t+=GLOBALS['MOT_RED_SF_duration']/n_steps/2
