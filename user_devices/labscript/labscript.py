...
class AnalogQuantity(Output):
    ...
    def constant(self,t,value,units=None):
        ...
        self.add_instruction(t, float(value), units)
...
class DDSQuantity(Device):
    ...
    def __init__(self, name, parent_device, connection, digital_gate={}, freq_limits=None, freq_conv_class=None, freq_conv_params={},
        ...
        self.setpoint = AnalogQuantity(self.name + '_setpoint', self, 'setpoint', phase_limits, phase_conv_class, phase_conv_params) #TODO: update parameters for setpoint
    ...
    def sepoint_pid(self, t, value, units=None):
        """Set the stepoint of the input for PID function.
        ...
        Args:
            ...
            units: Units that the value is defined in.
        """
        self.setpoint.constant(t, value, units)
