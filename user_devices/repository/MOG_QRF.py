...
# /MOGlabs QRF.py                                                   #
#                                                                   #
# Copyright 2013, Florence University                               #
#                                                                   #
...
@labscript_device
class MOG_QRF(IntermediateDevice):
    """
    ...
    def generate_code(self, hdf5_file):
        ...
        dtypes = [('freq%d'%i,np.uint32) for i in range(4)] + \
...
class MOG_QRF_Tab(DeviceTab):
    def initialise_GUI(self):
        ...
        self.create_worker("main_worker",MOG_QRF_Worker,{'addr':self.addr,
                                                              'port': self.port})
