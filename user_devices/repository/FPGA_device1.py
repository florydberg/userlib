...
default_out_prim = {'output 0':('sync out','high level')}
default_out_sec  = {}
...
class FPGA_board(PseudoclockDevice):
    ...
    def __init__(self, name, ip_address, ip_port, bus_rate=MAX_BUS_RATE, num_racks=1, trigger_device=None, worker_args={}):
        if trigger_device is not None: trigger_connection = 'trigger' # we have to give a connection. name seems irrelevant.
    ...
    def transition_to_buffered(self, device_name, hdf5file, initial_values, fresh):
        ...
        with h5py.File(hdf5file,'r') as hdf5_file:
            ...
            if len(data) == 0:
                ...
                save_print('input   control 0x%x' % (self.ctrl_in))
