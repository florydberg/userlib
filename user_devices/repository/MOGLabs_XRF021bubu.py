...
class MOGDeviceBubu(PseudoclockDevice):
    serial = None
    def __init__(self, name, addr,port=None,  trigger_device=None, trigger_connection=None, timeout=1,check=True,debug=False):
