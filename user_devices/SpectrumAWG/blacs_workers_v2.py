...
class SpectrumAWGWorker(Worker):
    ...
    def init(self):
        ...
        self.AWG.set_flag_IO('X0', 'RUNSTATE') # Set X0 as output for the end of the sequence
    ...
    def transition_to_buffered(self, device_name, h5_file, initial_values, fresh):
        ...
        if False:
            self.AWG.card_stop() #in this way reodering.py can update sequence without interfering with the current session
