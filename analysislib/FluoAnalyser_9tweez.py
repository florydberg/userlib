...
try:
    with Run(path).open('r+') as shot:
        ...
        T1=[134+deltax,102+deltay]
        T2=[152+deltax,102+deltay]
        T3=[170+deltax,102+deltay]
        T4=[134+deltax,120+deltay]
        T5=[152+deltax,120+deltay]
        T6=[170+deltax,120+deltay]
        T7=[134+deltax,138+deltay]
        T8=[152+deltax,138+deltay]
        T9=[170+deltax,138+deltay]  


        # deltax=-32
        # deltay=24

        # T1=[142+deltax,102+deltay]
        # T2=[153+deltax,102+deltay]
        # T3=[168+deltax,102+deltay]
        # T4=[142+deltax,116+deltay]
        # T5=[153+deltax,116+deltay]
        # T6=[168+deltax,116+deltay]
        # T7=[142+deltax,128+deltay]
        # T8=[153+deltax,128+deltay]
        # T9=[168+deltax,128+deltay]  
        ...
        TweezArea4=patches.Circle(T4, Tray, linewidth=1, edgecolor='b', facecolor='none')
        TweezArea5=patches.Circle(T5, Tray, linewidth=1, edgecolor='b', facecolor='none')
        TweezArea6=patches.Circle(T6, Tray, linewidth=1, edgecolor='b', facecolor='none')
        TweezArea7=patches.Circle(T7, Tray, linewidth=1, edgecolor='b', facecolor='none')
        TweezArea8=patches.Circle(T8, Tray, linewidth=1, edgecolor='b', facecolor='none')
        TweezArea9=patches.Circle(T9, Tray, linewidth=1, edgecolor='b', facecolor='none')
        ...
        TweezerSpot4=FluoImag[T4[1]-Tray:T4[1]+Tray, T4[0]-Tray:T4[0]+Tray]
        TweezerSpot5=FluoImag[T5[1]-Tray:T5[1]+Tray, T5[0]-Tray:T5[0]+Tray]
        TweezerSpot6=FluoImag[T6[1]-Tray:T6[1]+Tray, T6[0]-Tray:T6[0]+Tray]
        TweezerSpot7=FluoImag[T7[1]-Tray:T7[1]+Tray, T7[0]-Tray:T7[0]+Tray]
        TweezerSpot8=FluoImag[T8[1]-Tray:T8[1]+Tray, T8[0]-Tray:T8[0]+Tray]
        TweezerSpot9=FluoImag[T9[1]-Tray:T9[1]+Tray, T9[0]-Tray:T9[0]+Tray]
        HaloSpot3=FluoImag[H3[1]-Hray:H3[1]+Hray, H3[0]-Hray:H3[0]+Hray]



        plt.gca().add_patch(TweezArea9)
        plt.gca().add_patch(TweezArea8)
        plt.gca().add_patch(TweezArea7)
        plt.gca().add_patch(TweezArea6)
        plt.gca().add_patch(TweezArea5)
        plt.gca().add_patch(TweezArea4)
        plt.gca().add_patch(TweezArea3)
        plt.gca().add_patch(TweezArea2)
        plt.gca().add_patch(TweezArea1)
        ...
        shot.save_result('tw4_integral', (sum(TweezerSpot4)))
        shot.save_result('tw5_integral', (sum(TweezerSpot5)))
        shot.save_result('tw6_integral', (sum(TweezerSpot6)))
        shot.save_result('tw7_integral', (sum(TweezerSpot7)))
        shot.save_result('tw8_integral', (sum(TweezerSpot8)))
        shot.save_result('tw9_integral', (sum(TweezerSpot9)))
