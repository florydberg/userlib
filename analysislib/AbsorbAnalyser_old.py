...
if True: #functions definition
    ...
    def fit_gaussian(shot, value, RX, RY, data, scan_parameter, scan_unit, binfactor, N_2D, binning):
        ...
        print((x_0, len(inty)-y_0), ampguess)
        ...
        ax[1].imshow(data, cmap='viridis', vmin=0, vmax=V_MAX*1.5, extent=( conv*x.min(), conv*x.max(),conv*y.min(), conv*y.max()))
...
if True:# ROI Selection
    ...
    b0=(300,400)    # Starting point for the Probe area
    ray=400       
######################
