...
with Run(path).open('r+') as shot:
    ...
    # Tray=6
    Tray=2
    BGspot=FluoImag[0:2*Tray, 0:2*Tray]
    MOTray=50

    #Old plot with integrated signal over the two axes
    ...
    if ROI=='full': #ROIS
        ...
        MotSpot=FluoImag[MOT0[1]-MOTray:MOT0[1]+MOTray, MOT0[0]-MOTray:MOT0[0]+MOTray]-np.average(BGspot)
        if second_shot:
            MotSpot2nd=SecondImag[MOT0[1]-MOTray:MOT0[1]+MOTray, MOT0[0]-MOTray:MOT0[0]+MOTray]-np.average(BGspot)
        # plt.gca().add_patch(MOTArea)
    elif ROI=='tweez':
        MOTArea=patches.Circle(MOTray, MOTray, linewidth=1, edgecolor='r', facecolor='none')
        MotSpot=FluoImag-np.average(BGspot)
        if second_shot:
            MotSpot2nd=SecondImag-np.average(BGspot)


    # print(np.average(BGspot))

    # plt.legend(['Tweezer Area'], loc ="lower right")
    ...
    TweezerSpot4=MotSpot[T4[1]-Tray:T4[1]+Tray, T4[0]-Tray:T4[0]+Tray]
    TweezerSpot5=MotSpot[T5[1]-Tray:T5[1]+Tray, T5[0]-Tray:T5[0]+Tray]
    TweezerSpot6=MotSpot[T6[1]-Tray:T6[1]+Tray, T6[0]-Tray:T6[0]+Tray]
    TweezerSpot7=MotSpot[T7[1]-Tray:T7[1]+Tray, T7[0]-Tray:T7[0]+Tray]
    TweezerSpot8=MotSpot[T8[1]-Tray:T8[1]+Tray, T8[0]-Tray:T8[0]+Tray]
    TweezerSpot9=MotSpot[T9[1]-Tray:T9[1]+Tray, T9[0]-Tray:T9[0]+Tray]
    ...
    if not data_frame['tweezers']:
        ...
        #2nd shot analysis
    if second_shot:
        TweezerSpot1_2nd=MotSpot2nd[T1[1]-Tray:T1[1]+Tray, T1[0]-Tray:T1[0]+Tray]
        TweezerSpot2_2nd=MotSpot2nd[T2[1]-Tray:T2[1]+Tray, T2[0]-Tray:T2[0]+Tray]
        TweezerSpot3_2nd=MotSpot2nd[T3[1]-Tray:T3[1]+Tray, T3[0]-Tray:T3[0]+Tray]
        TweezerSpot4_2nd=MotSpot2nd[T4[1]-Tray:T4[1]+Tray, T4[0]-Tray:T4[0]+Tray]
        TweezerSpot5_2nd=MotSpot2nd[T5[1]-Tray:T5[1]+Tray, T5[0]-Tray:T5[0]+Tray]
        TweezerSpot6_2nd=MotSpot2nd[T6[1]-Tray:T6[1]+Tray, T6[0]-Tray:T6[0]+Tray]
        TweezerSpot7_2nd=MotSpot2nd[T7[1]-Tray:T7[1]+Tray, T7[0]-Tray:T7[0]+Tray]
        TweezerSpot8_2nd=MotSpot2nd[T8[1]-Tray:T8[1]+Tray, T8[0]-Tray:T8[0]+Tray]
        TweezerSpot9_2nd=MotSpot2nd[T9[1]-Tray:T9[1]+Tray, T9[0]-Tray:T9[0]+Tray]
        ...
        if not data_frame['tweezers']:
            ...
            #Background
            # TweezerAnalysis(BGspot, 6, plotting=False, GaussFit=False)

            # shot.save_result('photo_background_2nd', sum(MotSpot2nd[round(MOTray/4)-waist:round(MOTray/4)+waist, MOTray-waist:MOTray+waist])/10)
...
ax1.imshow(MotSpot[T1[1]-Tray:T1[1]+Tray, T1[0]-Tray:T1[0]+Tray],cmap='plasma',vmin=0, vmax=50) #vmax=np.amax(MotSpot)
ax1.axes.get_xaxis().set_ticks([])
ax1.axes.get_yaxis().set_ticks([])
ax1.set_title('ROI 1')
ax2.imshow(MotSpot[T2[1]-Tray:T2[1]+Tray, T2[0]-Tray:T2[0]+Tray],cmap='plasma',vmin=0, vmax=50) #vmax=np.amax(MotSpot)
ax2.axes.get_xaxis().set_ticks([])
ax2.axes.get_yaxis().set_ticks([])
ax2.set_title('ROI 2')
ax3.imshow(MotSpot[T3[1]-Tray:T3[1]+Tray, T3[0]-Tray:T3[0]+Tray], cmap='plasma',vmin=0, vmax=50) #vmax=np.amax(MotSpot)
ax3.axes.get_xaxis().set_ticks([])
ax3.axes.get_yaxis().set_ticks([])
ax3.set_title('ROI 3')
ax4.imshow(MotSpot[T4[1]-Tray:T4[1]+Tray, T4[0]-Tray:T4[0]+Tray], cmap='plasma',vmin=0, vmax=50) #vmax=np.amax(MotSpot)
ax4.axes.get_xaxis().set_ticks([])
ax4.axes.get_yaxis().set_ticks([])
ax4.set_title('ROI 4')
ax5.imshow(MotSpot[T5[1]-Tray:T5[1]+Tray, T5[0]-Tray:T5[0]+Tray], cmap='plasma',vmin=0, vmax=50) #vmax=np.amax(MotSpot)
ax5.axes.get_xaxis().set_ticks([])
ax5.axes.get_yaxis().set_ticks([])
ax5.set_title('ROI 5')
ax6.imshow(MotSpot[T6[1]-Tray:T6[1]+Tray, T6[0]-Tray:T6[0]+Tray],cmap='plasma',vmin=0, vmax=50) #vmax=np.amax(MotSpot)
ax6.axes.get_xaxis().set_ticks([])
ax6.axes.get_yaxis().set_ticks([])
ax6.set_title('ROI 6')
ax7.imshow(MotSpot[T7[1]-Tray:T7[1]+Tray, T7[0]-Tray:T7[0]+Tray], cmap='plasma',vmin=0, vmax=50) #vmax=np.amax(MotSpot)
ax7.axes.get_xaxis().set_ticks([])
ax7.axes.get_yaxis().set_ticks([])
ax7.set_title('ROI 7')
ax8.imshow(MotSpot[T8[1]-Tray:T8[1]+Tray, T8[0]-Tray:T8[0]+Tray], cmap='plasma',vmin=0, vmax=50) #vmax=np.amax(MotSpot)
ax8.axes.get_xaxis().set_ticks([])
ax8.axes.get_yaxis().set_ticks([])
ax8.set_title('ROI 8')
ax9.imshow(MotSpot[T9[1]-Tray:T9[1]+Tray, T9[0]-Tray:T9[0]+Tray], cmap='plasma',vmin=0, vmax=50) #vmax=np.amax(MotSpot)
...
if second_shot:
    plt.figure()
    plt.imshow(MotSpot2nd, cmap='plasma',vmin=0, vmax=30) #vmax=np.amax(MotSpot)
    plt.rcParams.update({'font.size': 20})
    # plt.title('Mot Spot')
    n_ticks=7
    x_values=np.round(linspace(0,(MotSpot.shape[0])*effective_pixel_size*1e6*(n_ticks-1)/n_ticks, n_ticks),2)
